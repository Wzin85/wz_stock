...
STOP_LOSS=179
RR_RATIO=2.4
CATALYST=실적 호조 후 신고가 돌파 시도, AI 수요 모멘텀
...
- CATALYST = the single most important driver or context that could move this stock over the holding horizon, in Korean (e.g. earnings setup, sector momentum, technical breakout/breakdown, macro event). If there is no clear catalyst, say so plainly (예: "뚜렷한 촉매 없음, 기술적 흐름 위주"). Do NOT invent specific news, dates, or numbers — describe the type of driver in general terms only.
...
function parseInterpret(text) {
  ...
  return {
    ...
    rr_ratio: d.RR_RATIO ? parseFloat(d.RR_RATIO) : null, catalyst: d.CATALYST || null,
                ...
                <div style={{ ...s.card, borderColor: rc + "33", borderTop: "none", borderTopLeftRadius: 0, borderTopRightRadius: 0 }}>
                  ...
                  {r.catalyst && (
                    <div style={{ marginTop: "10px", padding: "9px 12px", borderRadius: "3px", background: "#0b1522", border: "1px solid #182434" }}>
                      <div style={{ ...s.lbl, color: "#00e5a0", marginBottom: "3px" }}>⚡ 핵심 촉매</div>
                      <div style={{ fontSize: "11px", color: "#b0c4d8", lineHeight: 1.5 }}>{r.catalyst}</div>
